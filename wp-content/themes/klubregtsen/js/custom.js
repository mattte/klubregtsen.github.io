...
(function($) {
    ...
    $(document).ready(function() {
        ...
        */
        ...
        /* Portfolio Images
        ==================================================================================== */
        $('#gallery-wrapper > .block').each(function(i, el) {
        		$(el).height($(el).width());
        	});
        ...
        $('#gallery-wrapper').magnificPopup({
            ...
            image: {
                ...
                titleSrc: function(item) {
                	  console.log(item.el.parent().find('.portfolio-desc').html().replace('<span', '<a').replace('/span>', '/a>'));
                    return item.el.parent().find('.portfolio-desc').html().replace('<span', '<a').replace('/span>', '/a>'); // place .html() if you need to show categories too.
                }
            },
        ...
        */
        ...
        ==================================================================================== * /
        if(false && $("#countdown").length) {
            CountDownTimer('09/24/2016 12:00 AM', 'countdown');
        }
